...
# 2 сторінки/блоки з сайту: Пакети (1–10), Плівки (11–15)
PRODUCTS_MAGNUM = [
    # Блок 1 — Пакети (10 товарів)
    ...
    {"name_uk": "Пакети з дном", "name_en": "Bags with bottom gusset", "slug": "pakety-z-dnom", "category_slug": "pakety", "image_path": None, "order": 7},
    {"name_uk": "Пакети з єврослотом", "name_en": "Bags with euro slot", "slug": "pakety-yevrosnlot", "category_slug": "pakety", "image_path": None, "order": 8},
    {"name_uk": "Конусні пакети", "name_en": "Conical bags", "slug": "pakety-konusni", "category_slug": "pakety", "image_path": None, "order": 9},
    {"name_uk": "Пакет \"дой-пак\"", "name_en": "Doy-pack pouch", "slug": "doj-pak", "category_slug": "pakety", "image_path": "1-81-1.png", "order": 10},
    # Блок 2 — Плівки (5 товарів)
    {"name_uk": "Плівка поліетиленова", "name_en": "Polyethylene film", "slug": "plivka-polietilenova", "category_slug": "plivky", "image_path": "Group-825.png", "order": 11},
    {"name_uk": "BOPP плівка", "name_en": "BOPP film", "slug": "bopp-plivka", "category_slug": "plivky", "image_path": "Group-826.png", "order": 12},
    {"name_uk": "(СРР) Плівка поліпропіленова", "name_en": "CPP polypropylene film", "slug": "plivka-cpp", "category_slug": "plivky", "image_path": "Group-827.png", "order": 13},
    {"name_uk": "Плівка з друком", "name_en": "Printed film", "slug": "plivka-druk", "category_slug": "plivky", "image_path": "1-85.png", "order": 14},
    {"name_uk": "Плівка з перфорацією", "name_en": "Perforated film", "slug": "plivka-perforaciya", "category_slug": "plivky", "image_path": "1-86.png", "order": 15},
]
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        cat_map = {}
        for slug, name_uk in [("pakety", "Пакети"), ("plivky", "Плівки")]:
        ...
        for p in PRODUCTS_MAGNUM:
            ...
            if not created:
                ...
                product.brand = "Magnum"
                if public_id:
                    product.image = public_id
                product.save(update_fields=["name", "name_uk", "name_en", "meta_title", "meta_title_uk", "meta_title_en", "order", "image", "brand"])
